...
class Drawer extends Component {
  ...
  constructor(props) {
    ...
    this.translateX = 0;
    this.scale = 1;
    this.maxTranslateXValue = Math.ceil(this.state.dims.width * props.minimizeFactor);
  ...
  componentWillMount() {
    ...
    Dimensions.addEventListener("change", dims => this.setState({
      dims: dims.window
    }));
  }
  ...
  _onStartShouldSetPanResponder = (e, gestureState) => {
    console.log('_onStartShouldSetPanResponder')
  ...
  onDrawerAnimation() {
    ...
    Animated.timing(
      ...
      {
        toValue: 1,
        duration: this.props.duration || 2050,
